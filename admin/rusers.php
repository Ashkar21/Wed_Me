  ...
  padding: 2px 16px;
	...
	<body>
		...
		<div id="fh5co-couple" class="fh5co-section-gray">
			...
			<h1><b>Rejected Users</b></h1><br><br><br>
<?php

              include '../dbconnect.php';
              $p=1;
			  //$uname=$_SESSION['username']; 
              $result = mysqli_query($con,"SELECT * FROM tbl_users,tbl_login where tbl_users.email=tbl_login.username and tbl_login.user_status='2'");
...
?>
			<div class="card">
			  ...
			  <div class="container">
				...
				<a href="details2.php?id=<?php echo $row['email'];?>">View Details</a>
			  </div>
