  ...
  padding: 2px 16px;
	...
	<body>
		...
		<div id="fh5co-couple" class="fh5co-section-gray">
			...
			<h1><b>All User Details</b></h1><br><br><br>
<?php
           ...
           //$result = mysqli_query($con, "SELECT * FROM tbl_users WHERE email='$uname'");
...
<table id="customers">
	...
	<tr><td>Profile Created by :</td><td><?php echo $row['created_by'];?></td></tr>
	<tr><td>Gender :</td><td><?php echo $row['gender'];?></td></tr>
	<tr><td>Date of Birth :</td><td><?php echo $row['dob'];?></td></tr>
	<tr><td>Marital Status:</td><td><?php echo $row['marital_sts'];?></td></tr>
	<tr><td>Mobile Number:</td><td><?php echo $row['phno'];?></td></tr>
	<tr><td>Mail ID:</td><td><?php echo $row['email'];?></td></tr>
    <tr>
	<td><a href="reject.php?id=<?php echo $row['email'];?>" id="reject">REJECT</a></td></tr>
