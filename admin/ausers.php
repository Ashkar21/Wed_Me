      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <nav id="sidebar">
               ...
               <a href="index.php"><h4>W E D M E</h4></a>
  ...
  color: black;
	...
	<body>
		...
		<div id="fh5co-couple" class="fh5co-section-gray">
			...
			<h1><b>Approved Users</b></h1><br><br>
<?php

              include '../dbconnect.php';
              $p=1;
			  //$uname=$_SESSION['username']; 
              $result = mysqli_query($con,"SELECT * FROM tbl_users,tbl_login where tbl_users.email=tbl_login.username and tbl_login.user_status='1'");
...
?>
			<div class="card">
			  ...
			  <div class="container">
				...
				<a style="background-color:black;" href="details1.php?id=<?php echo $row['email'];?>">View Details</a>
			  </div>
			</div>
<?php
			  }
