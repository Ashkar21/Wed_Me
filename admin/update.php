...
<center>
		<div id="fh5co-couple" class="fh5co-section-gray">
			...
			<h1><b>Update Username / Password</b></h1><br><br><br>
<?php
...
<table id="customers">
	...
	<tr><td>Username :</td><td><input type="email" name="username" value="<?php echo $row['username'];?>"></td></tr>
	<tr><td>Password :</td><td><input type="text" name="password" value="<?php echo $row['password'];?>"
	pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
...
?>
            <?php
							 ...
							 if(isset($_POST['submit']))
							 {
								 ...
								 $sql="update tbl_login set username='$_POST[username]',password='$_POST[password]' where type='admin'";
								 //echo"$sql";
